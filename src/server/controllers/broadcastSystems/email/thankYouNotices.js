...
function sendThankYou(record) {
    let today = new Date()
    let messageBodyPartA = `<div>Dear ${record.name},</div><br><div>This email is from <a href="${eVars.HOST}:${eVars.PORT}">Gentry Way Co., Ltd.</a><br><br>Thank you very much for registering on our website.<br>Attached is a copy of our PDF catalog.<br><br>Please have a look and let us know if you see any items of interest.<br></div>`
